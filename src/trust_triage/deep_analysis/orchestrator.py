            ...
            try:
                ...
                if capa_result:
                    ...
                    if capa_sha256 and capa_sha256.lower() != sample_sha256.lower():
                        raise ValueError(f"Result SHA256 ({capa_sha256}) does not match sample ({sample_sha256})")
            ...
            try:
                ...
                if floss_result:
                    ...
                    if floss_sha256 and floss_sha256.lower() != sample_sha256.lower():
                        raise ValueError(f"Result SHA256 ({floss_sha256}) does not match sample ({sample_sha256})")
